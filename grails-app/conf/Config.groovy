...
if (System.properties["appconfig.root"]) {
    grails.config.locations << "file:" + System.properties["appconfig.root"] + "/${appName}/application.groovy"
}

environments {
    development {
        grails.config.locations << "file:appconfig.root/application-local.groovy"
    }
}
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
    ...
    '/search/*':                      ['isFullyAuthenticated()'],
    '/characterSheet/*':              ['isFullyAuthenticated()'],
    '/user/save':                     ['permitAll'],
    '/login/**':                      ['permitAll'],
	'/assets/**':                     ['permitAll'],
	'/**/js/**':                      ['permitAll'],
